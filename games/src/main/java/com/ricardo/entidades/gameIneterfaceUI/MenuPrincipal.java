...
public class MenuPrincipal extends GameObjectos{

    private String[] opicoes = { "novo", "sobre", "sair"};
    private int opcao = 0;
    ...
    public void render(Graphics g) {
        ...
        g.drawString("Novo", 160, 280);
        g.drawString("Sobre", 160, 330);
        g.drawString("Sair", 160, 380);

        if(opicoes[opcao].equals("novo")){
            g.drawString(">", 135, 280);

        }else if (opicoes[opcao].equals("sobre")) {
