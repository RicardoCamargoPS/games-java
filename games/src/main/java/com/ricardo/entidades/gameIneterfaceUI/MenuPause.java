...
public class MenuPause extends GameObjectos {

    private String[] opicoes = { "continuar", "reiniciar", "sair"};
    private int opcao = 0;
    ...
    public void render(Graphics g) {
        ...
        g.drawString("Continuar", 160, 280);
        g.drawString("Reiniciar", 160, 330);
        g.drawString("Sair", 160, 380);

        if(opicoes[opcao].equals("continuar")){
            g.drawString(">", 135, 280);

        }else if (opicoes[opcao].equals("reiniciar")) {
